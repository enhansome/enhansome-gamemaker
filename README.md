...
* [Aseprite's source code](https://github.com/aseprite/aseprite) ⭐ 39,059 | 🐛 1,991 | 🌐 C++ | 📅 2026-08-25 - Can be compiled for free.
...
* [GML-OOP](https://github.com/Mtax-Development/GML-OOP) ⭐ 34 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-08-28 - A constructor library for operating the primary functionalities of GameMaker.
...
* [GM-ExtensionGenerator](https://github.com/YoYoGames/GM-ExtensionGenerator) ⭐ 25 | 🐛 1 | 🌐 C# | 📅 2026-08-27 - Official, schema-driven code generator for native extensions.
...
* [Ganary](https://github.com/bscotch/ganary) ⭐ 10 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-27 - Uses Olympus to perform regression tests.
...
* [SpriteSource](https://github.com/bscotch/stitch/tree/develop/packages/sprite-source) ⭐ 158 | 🐛 33 | 🌐 TypeScript | 📅 2026-06-15 - Utilities for creating art asset pipelines.
...
* [Dracula Theme](https://github.com/dracula/gamemaker-studio) ⭐ 92 | 🐛 6 | 📅 2025-09-21 - A dark theme for the IDE.
...
* If you need more general game development resources, check out [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 3,115 | 🐛 15 | 📅 2026-08-25 or [MagicTools](https://github.com/ellisonleao/magictools) ⭐ 17,209 | 🐛 14 | 🌐 Markdown | 📅 2026-08-25.
...
Have something awesome to share? Check out the [Contributing Guidelines](https://github.com/bytecauldron/awesome-gamemaker/blob/main/CONTRIBUTING.md) ⭐ 501 | 🐛 1 | 📅 2026-08-23.
