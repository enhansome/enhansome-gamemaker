...
* [Aseprite's source code](https://github.com/aseprite/aseprite) ⭐ 38,777 | 🐛 1,997 | 🌐 C++ | 📅 2026-08-14 - Can be compiled for free.
...
* [SNAP](https://github.com/JujuAdams/SNAP) ⭐ 101 | 🐛 6 | 🌐 Game Maker Language | 📅 2026-07-08 - Easy data format saving and loading. Please note that newer versions of GameMaker contain `json_parse` and `json_stringify`. However, if you are converting csv, ini, xml, etc, you may find this very useful.
...
* [GML-OOP](https://github.com/Mtax-Development/GML-OOP) ⭐ 34 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-08-16 - A constructor library for operating the primary functionalities of GameMaker.
...
* [Matrices](https://github.com/JujuAdams/matrices) ⭐ 7 | 🐛 3 | 🌐 Game Maker Language | 📅 2024-02-18 - A collection of matrix handling scripts.
* [BSONGML](https://github.com/LAGameStudio/BSONGML) ⭐ 6 | 🐛 0 | 🌐 Game Maker Language | 📅 2025-03-22 - Save and load GML structured data in binary files, skirting memory and performance concerns associated with loading JSON as a string.
* [Binder](https://github.com/Homunculus84/Binder) ⭐ 6 | 🐛 0 | 🌐 Game Maker Language | 📅 2025-06-19 - A binary search library for efficient lookups on large datasets.
* [Map](https://github.com/GameMakerDiscord/Map.gml) ⭐ 3 | 🐛 0 | 🌐 HTML | 📅 2020-06-14 - Hash table implementations.
* [Ngrams](https://github.com/tinkerer-red/Ngrams) ⭐ 3 | 🐛 0 | 🌐 Game Maker Language | 📅 2025-12-10 - Lightweight n-gram library for fuzzy search, predictive text or token sequence modeling.
...
* [GM-ExtensionGenerator](https://github.com/YoYoGames/GM-ExtensionGenerator) ⭐ 25 | 🐛 3 | 🌐 C# | 📅 2026-08-14 - Official, schema-driven code generator for native extensions.
...
* [GM Sysinfo](https://github.com/SpikeHD/gm-sysinfo) ⭐ 12 | 🐛 1 | 🌐 Rust | 📅 2023-12-12 - Cross-platform extension for getting system information and resource usage.
* [GMSDLL.rs](https://github.com/YAL-GameMaker/GMSDLL.rs?) ⭐ 7 | 🐛 0 | 🌐 Rust | 📅 2025-09-14 - Example on how to make native DLL extensions in Rust.
...
* [DoLater](https://github.com/JujuAdams/DoLater) ⭐ 45 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-06-07 - Deferred code execution improving on the native call\_later() function.
* [GMMT](https://github.com/erkan612/GMMT) ⭐ 8 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-08-09 - Tweening framework with 30+ easing functions, keyframes, clips, motion paths, spring physics, oscillation, perlin noise, and full playback control.
* [GMTimeLine](https://github.com/TimVN/GMTimeLine) ⭐ 7 | 🐛 0 | 🌐 Yacc | 📅 2022-11-03 - A pure code alternative to GameMaker timelines.
...
* [Agenda](https://github.com/benal20/Agenda.gml) ⭐ 4 | 🐛 0 | 🌐 Yacc | 📅 2026-05-03 - Schedule and delay the execution of callbacks.
...
* [Timer](https://github.com/nommiin/Timers) ⭐ 3 | 🐛 0 | 🌐 Yacc | 📅 2020-04-24 - Interval-based timing methods modeled after JS's setTimeout and setInterval.
* [STAGING](https://github.com/sdelaughter/STAGING) ⭐ 3 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-07-20 - Split initialization tasks over multiple frames, including support for asynchronous tasks.
* [wTimer](https://mors-games.itch.io/wtimer) - Robust alternative for alarms.

## Async

* [Coroutines](https://github.com/JujuAdams/Coroutines) ⭐ 84 | 🐛 3 | 🌐 Game Maker Language | 📅 2025-06-29 - Asynchronous functions for GameMaker.
* [Promises](https://github.com/YAL-GameMaker/Promise.gml) ⭐ 26 | 🐛 0 | 🌐 Game Maker Language | 📅 2023-07-21 - An adaptation of JavaScript Promises.
* [SimThreads](https://github.com/tabularelf/SimThreads) ⭐ 15 | 🐛 0 | 🌐 Game Maker Language | 📅 2024-05-07 - Simulated threads for GameMaker.
* [GML Promise](https://github.com/tinkerer-red/GML-Promise) ⭐ 9 | 🐛 1 | 🌐 Game Maker Language | 📅 2025-11-27 - Another JS-style promise library.
* [MultiProcessing](https://github.com/tinkerer-red/MultiProcessing) ⭐ 2 | 🐛 1 | 🌐 Yacc | 📅 2023-11-06 - A proof of concept for multiprocessing in GameMaker.

## Utilities

* [Catspeak](https://github.com/katsaii/catspeak-lang) ⭐ 132 | 🐛 9 | 🌐 Game Maker Language | 📅 2026-07-04 - Cross-platform programming language for modding support.
...
* [Dynamo](https://github.com/JujuAdams/Dynamo) ⭐ 35 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-07-08 - Dynamic data loader.
* [DDDEditor](https://github.com/DragoniteSpam/DDDEditorGMS2) ⭐ 34 | 🐛 9 | 🌐 Game Maker Language | 📅 2026-07-06 - General purpose game editor.
* [GMBenchmark](https://github.com/DragoniteSpam/GMBenchmark) ⭐ 34 | 🐛 2 | 🌐 Game Maker Language | 📅 2026-02-10 - A tool to benchmark GML code.
...
* [Figgy](https://github.com/glebtsereteli/Figgy) ⭐ 27 | 🐛 4 | 🌐 Game Maker Language | 📅 2026-08-10 - Centralized and persistent live configs for seamless game tuning and balancing.
* [GMLodash](https://github.com/DatZach/GMLodash) ⭐ 25 | 🐛 1 | 🌐 Game Maker Language | 📅 2021-11-28 - Functional programming in GML.
* [Canvas](https://github.com/tabularelf/Canvas) ⭐ 22 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-04-11 - Another great solution for surface management.
...
* [GMLiteSearch](https://github.com/erkan612/GMLiteSearch) ⭐ 14 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-08-06 - Fast, flexible full‑text search for GameMaker. Built for small to medium datasets (10k‑50k+ docs) with real‑time indexing, fuzzy search, n‑grams, BM25/TF‑IDF scoring, and persistence.
...
* [Polarca](https://github.com/VitorEstevam/polarca) ⭐ 12 | 🐛 1 | 🌐 Game Maker Language | 📅 2024-03-11 - Interpolation functions.
* [Gumshoe](https://github.com/JujuAdams/Gumshoe) ⭐ 12 | 🐛 0 | 🌐 Game Maker Language | 📅 2024-03-04 - Simple deep file search function.
* [CoreExtension](https://github.com/blueburncz/CoreExtension) ⚠️ Archived - A collection of CC0 programming libraries. (archived)
* [RunGML](https://github.com/sdelaughter/RunGML) ⭐ 10 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-07-03 - A runtime scripting language with a Lisp-like syntax.  Facilitates modding support via included JSON files, and debugging/live coding via an in-game console.
* [Tweeny](https://github.com/Kruger0/Tweeny) ⭐ 8 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-08-15 - A fire-and-forget tweening library with support for animation curves and ease functions
...
* [RenderStack](https://github.com/FoxyOfJungle/RenderStack) ⭐ 7 | 🐛 0 | 🌐 Game Maker Language | 📅 2025-12-17 - Organize your game's rendering into a customizable order.
* [GMVex](https://github.com/erkan612/GMVex) ⭐ 7 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-07-30 - Vector graphics framework with SVG support, TrueType font rendering, path boolean operations and fill/stroke rendering.
...
* [GMEdit](https://github.com/YellowAfterlife/GMEdit) ⭐ 370 | 🐛 24 | 🌐 JavaScript | 📅 2026-07-22 - Code editor to use in conjunction with GameMaker.
...
* [rt-shell](https://github.com/daikon-games/rt-shell) ⭐ 96 | 🐛 4 | 🌐 Game Maker Language | 📅 2023-07-11 - Easy to use in-game shell. Create your own commands, command meta data, command suggestions, history, etc.
* [Crispy](https://github.com/bfrymire/crispy) ⭐ 40 | 🐛 8 | 🌐 Game Maker Language | 📅 2025-11-26 - Unit testing in GameMaker.
* [Snitch](https://github.com/JujuAdams/Snitch) ⭐ 39 | 🐛 2 | 🌐 Game Maker Language | 📅 2026-07-29 - Crash and logging system.
* [Gobo](https://github.com/Pizzaandy/Gobo/) ⭐ 33 | 🐛 4 | 🌐 C# | 📅 2025-11-21 - An opinionated code formatter for GML.
* [gms2-test](https://github.com/pmarincak/gms2-test) ⭐ 28 | 🐛 0 | 🌐 Game Maker Language | 📅 2022-12-27 - Unit testing framework.
* [Lookout](https://github.com/glebtsereteli/Lookout) ⭐ 21 | 🐛 8 | 🌐 Game Maker Language | 📅 2026-08-08 - Helpful debug overlay views.
...
* [Ganary](https://github.com/bscotch/ganary) ⭐ 10 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-16 - Uses Olympus to perform regression tests.
...
* [Good Vibes](https://github.com/mrdaneeyul/good-vibes) ⭐ 27 | 🐛 0 | 🌐 Yacc | 📅 2022-11-24 - Device vibration.
...
* [InputTouch](https://github.com/AlubJ/InputTouch) ⭐ 9 | 🐛 5 | 🌐 Game Maker Language | 📅 2026-06-29 - Touch controls plugin for Input.
...
* [Scribble](https://github.com/JujuAdams/scribble) ⭐ 415 | 🐛 28 | 🌐 Game Maker Language | 📅 2026-08-10 - Efficient multi-effects text renderer.
* [Chatterbox](https://github.com/JujuAdams/chatterbox) ⭐ 174 | 🐛 9 | 🌐 Game Maker Language | 📅 2026-08-13 - Narrative scripting tool.
* [Crochet](https://github.com/FaultyFunctions/Crochet) ⭐ 119 | 🐛 38 | 🌐 Svelte | 📅 2026-05-28 - An interactive dialogue editor for writers and programmers.
* [YUI](https://github.com/shdwcat/YUI) ⭐ 66 | 🐛 40 | 🌐 Game Maker Language | 📅 2026-08-13 - A UI system with live reloading, template system, data binding, and a drag and drop feature.
* [Textboxy](https://github.com/glitchroy/textboxy) ⭐ 65 | 🐛 9 | 🌐 Game Maker Language | 📅 2023-03-05 - Simple textboxes.
* [Bento](https://github.com/JujuAdams/Bento) ⭐ 53 | 🐛 2 | 🌐 Game Maker Language | 📅 2026-08-16 - Cross-platform UI framework.
...
* [LimeUI](https://github.com/Limekys/LimeUI) ⭐ 36 | 🐛 2 | 🌐 Game Maker Language | 📅 2026-08-11 - Flexpanel system for modern, touch-friendly interfaces.
* [GMUI](https://github.com/erkan612/GMUI) ⭐ 31 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-08-10 - Immediate mode GameMaker UI library, tons of UI components.
...
* [SimpleBook](https://github.com/Gizmo199/SimpleBook) ⭐ 11 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-05-07 - Simple book rendering framework.
* [MajorGUI](https://github.com/erkan612/MajorGUI_GML) ⭐ 10 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-04-15 - Surface-based GUI that allows 100% control over UI styling and functionality.
...
* [Lexicon](https://github.com/tabularelf/lexicon) ⭐ 52 | 🐛 3 | 🌐 Game Maker Language | 📅 2026-07-11 - Another localization solution focused on simplifying implementation.
* [polyglot](https://github.com/daikon-games/polyglot) ⭐ 35 | 🐛 3 | 🌐 Game Maker Language | 📅 2026-02-23 - Localization library.
...
* [Krug's Localize System](https://github.com/Kruger0/Localize) ⭐ 20 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-08-12 - A localization system with real-time Google Sheets API synchronization.
...
* [Loj Hadron Collider](https://github.com/Lojemiru/Loj-Hadron-Collider) ⭐ 42 | 🐛 2 | 🌐 Yacc | 📅 2022-10-28 - A robust, pixel-perfect collision engine.
* [Fracture](https://github.com/GlebTsereteli/Fracture) ⭐ 14 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-07-25 - Physics-based destruction for procedural Box2D fracture effects.
...
* [Inverse Kinematics Extension](https://github.com/tonystr/Inverse-Kinematics-Extension-for-Gamemaker) ⭐ 4 | 🐛 0 | 📅 2017-12-26 - A library for working with inverse kinematics.
...
* [Disarm](https://github.com/NuxiiGit/disarm) ⚠️ Archived - A spriter skeletal animation at runtime.
* [AESnips](https://github.com/angelwire/AESnips) ⭐ 9 | 🐛 1 | 📅 2025-08-04 - A sprite playback system.
* [GM Animate](https://github.com/KormexGit/GM-Animate) ⭐ 9 | 🐛 3 | 🌐 Game Maker Language | 📅 2026-06-03 - Sprite animation manager.
* [conveyorbelt](https://github.com/imissmyfriends/conveyorbelt) ⭐ 7 | 🐛 3 | 🌐 JavaScript | 📅 2023-09-08 - Similar to ASESync. Export Aseprite files to GameMaker sprites.
...
* [GMEXT-FMOD](https://github.com/YoYoGames/GMEXT-FMOD) ⭐ 74 | 🐛 2 | 🌐 HTML | 📅 2026-08-12 - Official support for FMOD in GameMaker.
...
* [audioExt](https://github.com/tabularelf/audioExt) ⭐ 6 | 🐛 1 | 🌐 Game Maker Language | 📅 2024-12-07 - Sound External Loader/Unloader Manager.
* [Phonix](https://github.com/Andre-404/Phonix/) ⭐ 6 | 🐛 0 | 🌐 Game Maker Language | 📅 2022-06-18 - Compact audio system. Great for dynamic music!
* [LineAudio](https://github.com/WangleLine/LineAudio) ⭐ 5 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-07-25 - Audio helper functions.
...
* [GMRoomLoader](https://github.com/glebtsereteli/GMRoomLoader) ⭐ 127 | 🐛 7 | 🌐 Game Maker Language | 📅 2026-08-17 - Streamlined room loading at runtime. Great for reusable room prefabs and procedural generation.
...
* [Destructible Terrain](https://github.com/niksudan/gms2-destructible-terrain) ⭐ 32 | 🐛 2 | 🌐 Game Maker Language | 📅 2023-04-17 - An example of collidable, destructible terrain in GameMaker Studio using surfaces and grids.
...
* [Random Dungeon Generator](https://github.com/BlaXun/Random-Dungeon-Generator-GMS-2.3) ⭐ 10 | 🐛 7 | 🌐 Yacc | 📅 2020-06-30 - Combines user-defined chambers to create a dungeon.
...
* [Bulb](https://github.com/JujuAdams/Bulb) ⭐ 106 | 🐛 9 | 🌐 Game Maker Language | 📅 2026-07-08 - 2D lighting and shadows.
* [GameMaker Lighting Engine](https://github.com/bilouw/Gamemaker-Lighting-Engine) ⭐ 27 | 🐛 1 | 🌐 Game Maker Language | 📅 2019-02-15 - Tile-based Lighting Engine that projects shadows.
...
* [Outline Shader](https://github.com/Grisgram/gml-outline-shader-drawer) ⭐ 26 | 🐛 0 | 🌐 Game Maker Language | 📅 2024-10-16 - Draws outlines around sprites using a shader.
* [Bokeh Blur](https://github.com/XorDev/Bokeh/wiki) ⭐ 19 | 🐛 0 | 🌐 GLSL | 📅 2024-03-02 - Extension of the 1PassBlur which provides a different look. Similar to a real lens blur. Although it's much slower than 1Pass or Dual-Kawase.
...
* [Bonk](https://github.com/JujuAdams/Bonk) ⭐ 14 | 🐛 12 | 🌐 Game Maker Language | 📅 2026-08-03 - Another cool collision library handling a majority of collision shape use-cases.
...
* [Warp](https://github.com/evolutionleo/Warp) ⭐ 149 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-31 - A feature-rich framework for multiplayer games, written in GameMaker and Node.js.
* [Patchwire-GM](https://github.com/gm-core/patchwire-gm) ⭐ 36 | 🐛 0 | 🌐 Yacc | 📅 2020-09-13 - The network library from gm-core if you want to use this implementation without the entire gm-core suite.
* [MultiClient](https://github.com/tabularelf/MultiClient) ⭐ 31 | 🐛 1 | 🌐 Batchfile | 📅 2026-01-06 - Non-dll, multiple client launcher for network development.
* [HTTP GML](https://github.com/Sidorakh/http.gml) ⭐ 19 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-02-09 - Receive GET requests and upload files in GML.
...
* [GOG.gml](https://github.com/GameMakerDiscord/GOG.gml) ⭐ 11 | 🐛 1 | 🌐 HTML | 📅 2023-07-30 - A native extension for GOG.com SDK support.
...
* [STANNcam](https://github.com/jack27121/STANNcam) ⭐ 43 | 🐛 14 | 🌐 Game Maker Language | 📅 2026-04-26 - Camera and resolution manager.
...
* [SnowState](https://github.com/sohomsahaun/SnowState) ⭐ 178 | 🐛 3 | 🌐 Game Maker Language | 📅 2025-06-29 - Robust finite state machine.
...
* [OrbinautFramework](https://github.com/TrianglyRU/OrbinautFramework) ⭐ 124 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-08-16 - Accurate framework to make classic Sonic games.
* [Dracula Theme](https://github.com/dracula/gamemaker-studio) ⭐ 91 | 🐛 6 | 📅 2025-09-21 - A dark theme for the IDE.
* [CleanShapes](https://github.com/JujuAdams/Clean-Shapes) ⭐ 47 | 🐛 9 | 🌐 Game Maker Language | 📅 2026-05-26 - Antialiased primitives library for GameMaker.
...
* [Gruvbox Theme](https://github.com/heygleeson/Gruvbox-GMTheme) ⭐ 16 | 🐛 0 | 📅 2022-08-12 - A retro groove theme for the IDE.
* [Danmaku Project](https://github.com/OmegaX1000/DanmakuProject) ⭐ 14 | 🐛 0 | 🌐 Yacc | 📅 2021-05-03 - Bullet hell engine.
* [GameMaker Repo Badges](https://github.com/matthiaszarzecki/MadeWithGameMakerStudioBadges) ⭐ 14 | 🐛 0 | 📅 2025-06-13 - Fancy badges to add to your README files.
* [Tome](https://github.com/chesrowe/Tome/) ⭐ 14 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-05-12 - Automatically generate documentation sites from GameMaker projects.
* [Animated Flag](https://github.com/Grisgram/gml-animated-flag) ⭐ 13 | 🐛 0 | 🌐 Game Maker Language | 📅 2024-05-30 - Vertex-animated flag.
* [Piano example](https://github.com/gmclan-org/piano_example) ⭐ 7 | 🐛 0 | 🌐 Game Maker Language | 📅 2023-02-17 - Example of playing instrument notes by changing pitch, using only one audio file.
* [Pause example](https://github.com/gmclan-org/pause_no_surface) ⭐ 5 | 🐛 0 | 🌐 Game Maker Language | 📅 2021-09-21 - Simple example of a pause screen without using surfaces.
...
* If you need more general game development resources, check out [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 3,102 | 🐛 13 | 📅 2026-07-07 or [MagicTools](https://github.com/ellisonleao/magictools) ⭐ 17,141 | 🐛 12 | 🌐 Markdown | 📅 2026-08-16.
...
Have something awesome to share? Check out the [Contributing Guidelines](https://github.com/bytecauldron/awesome-gamemaker/blob/main/CONTRIBUTING.md) ⭐ 494 | 🐛 1 | 📅 2026-08-16.
