...
* [Aseprite's source code](https://github.com/aseprite/aseprite) ⭐ 39,631 | 🐛 2,001 | 🌐 C++ | 📅 2026-09-22 - Can be compiled for free.
...
* [GM-ExtensionGenerator](https://github.com/YoYoGames/GM-ExtensionGenerator) ⭐ 28 | 🐛 1 | 🌐 C# | 📅 2026-09-22 - Official, schema-driven code generator for native extensions.
...
* [GMMT](https://github.com/erkan612/GMMT) ⭐ 9 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-08-09 - Tweening framework with 30+ easing functions, keyframes, clips, motion paths, spring physics, oscillation, perlin noise, and full playback control.
...
* [GMLiteSearch](https://github.com/erkan612/GMLiteSearch) ⭐ 15 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-08-31 - Fast, flexible full‑text search for GameMaker. Built for small to medium datasets (10k‑50k+ docs) with real‑time indexing, fuzzy search, n‑grams, BM25/TF‑IDF scoring, and persistence.
...
* [Gobo](https://github.com/Pizzaandy/Gobo/) ⭐ 33 | 🐛 5 | 🌐 C# | 📅 2026-09-22 - An opinionated code formatter for GML.
...
* [Ganary](https://github.com/bscotch/ganary) ⭐ 10 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-22 - Uses Olympus to perform regression tests.
...
* [Bento](https://github.com/JujuAdams/Bento) ⭐ 55 | 🐛 1 | 🌐 Game Maker Language | 📅 2026-09-20 - Cross-platform UI framework.
...
* [GMUI](https://github.com/erkan612/GMUI) ⭐ 31 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-09-08 - Immediate mode GameMaker UI library, tons of UI components.
...
* [GMEXT-FMOD](https://github.com/YoYoGames/GMEXT-FMOD) ⭐ 74 | 🐛 2 | 🌐 HTML | 📅 2026-09-22 - Official support for FMOD in GameMaker.
...
* [BBMOD](https://github.com/blueburn-cz/BBMOD) ⭐ 119 | 🐛 5 | 🌐 Game Maker Language | 📅 2026-09-20 - 3D Rendering Solution. Comes with several modules to import obj, 3D camera setup, integration with ColMesh, and more.
...
* [Bonk](https://github.com/JujuAdams/Bonk) ⭐ 15 | 🐛 12 | 🌐 Game Maker Language | 📅 2026-09-22 - Another cool collision library handling a majority of collision shape use-cases.
...
* [MultiClient](https://github.com/tabularelf/MultiClient) ⭐ 30 | 🐛 1 | 🌐 Batchfile | 📅 2026-01-06 - Non-dll, multiple client launcher for network development.
...
* [DHook](https://github.com/tabularelf/DHook) ⭐ 5 | 🐛 0 | 🌐 Yacc | 📅 2024-05-07 - Discord integration.
...
* [GMNav](https://github.com/erkan612/GMNav) ⭐ 13 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-09-22 - High-performance, resumable navigation engine for GameMaker that handles grid, isometric, hex, and platformer maps with flow fields, dynamic costs, and multi-agent pathfinding.
...
* [OrbinautFramework](https://github.com/TrianglyRU/OrbinautFramework) ⭐ 128 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-09-20 - Accurate framework to make classic Sonic games.
...
* If you need more general game development resources, check out [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 3,139 | 🐛 19 | 📅 2026-08-25 or [MagicTools](https://github.com/ellisonleao/magictools) ⭐ 17,348 | 🐛 16 | 🌐 Markdown | 📅 2026-09-14.
...
Have something awesome to share? Check out the [Contributing Guidelines](https://github.com/bytecauldron/awesome-gamemaker/blob/main/CONTRIBUTING.md) ⭐ 507 | 🐛 2 | 📅 2026-09-20.
