...
* [Aseprite's source code](https://github.com/aseprite/aseprite) ⭐ 39,571 | 🐛 2,003 | 🌐 C++ | 📅 2026-09-18 - Can be compiled for free.
...
* [GML-OOP](https://github.com/Mtax-Development/GML-OOP) ⭐ 34 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-09-14 - A constructor library for operating the primary functionalities of GameMaker.
...
* [GM-ExtensionGenerator](https://github.com/YoYoGames/GM-ExtensionGenerator) ⭐ 27 | 🐛 1 | 🌐 C# | 📅 2026-09-19 - Official, schema-driven code generator for native extensions.
...
* [Coroutines](https://github.com/JujuAdams/Coroutines) ⭐ 83 | 🐛 3 | 🌐 Game Maker Language | 📅 2025-06-29 - Asynchronous functions for GameMaker.
...
* [SimThreads](https://github.com/tabularelf/SimThreads) ⭐ 14 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-09-18 - Simulated threads for GameMaker.
...
* [Catspeak](https://github.com/katsaii/catspeak-lang) ⭐ 135 | 🐛 9 | 🌐 Python | 📅 2026-08-19 - Cross-platform programming language for modding support.
...
* [DDDEditor](https://github.com/DragoniteSpam/DDDEditorGMS2) ⭐ 35 | 🐛 9 | 🌐 Game Maker Language | 📅 2026-08-31 - General purpose game editor.
...
* [Figgy](https://github.com/glebtsereteli/Figgy) ⭐ 27 | 🐛 5 | 🌐 Game Maker Language | 📅 2026-08-10 - Centralized and persistent live configs for seamless game tuning and balancing.
...
* [GMLiteSearch](https://github.com/erkan612/GMLiteSearch) ⭐ 14 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-08-31 - Fast, flexible full‑text search for GameMaker. Built for small to medium datasets (10k‑50k+ docs) with real‑time indexing, fuzzy search, n‑grams, BM25/TF‑IDF scoring, and persistence.
...
* [RunGML](https://github.com/sdelaughter/RunGML) ⭐ 10 | 🐛 1 | 🌐 Game Maker Language | 📅 2026-07-03 - A runtime scripting language with a Lisp-like syntax.  Facilitates modding support via included JSON files, and debugging/live coding via an in-game console.
* [Tweeny](https://github.com/Kruger0/Tweeny) ⭐ 9 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-08-15 - A fire-and-forget tweening library with support for animation curves and ease functions
...
* [rt-shell](https://github.com/daikon-games/rt-shell) ⭐ 97 | 🐛 4 | 🌐 Game Maker Language | 📅 2023-07-11 - Easy to use in-game shell. Create your own commands, command meta data, command suggestions, history, etc.
* [Crispy](https://github.com/bfrymire/crispy) ⭐ 41 | 🐛 8 | 🌐 Game Maker Language | 📅 2025-11-26 - Unit testing in GameMaker.
* [Snitch](https://github.com/JujuAdams/Snitch) ⭐ 39 | 🐛 2 | 🌐 Game Maker Language | 📅 2026-07-29 - Crash and logging system.
* [Gobo](https://github.com/Pizzaandy/Gobo/) ⭐ 33 | 🐛 5 | 🌐 C# | 📅 2025-11-21 - An opinionated code formatter for GML.
* [gms2-test](https://github.com/pmarincak/gms2-test) ⭐ 28 | 🐛 0 | 🌐 Game Maker Language | 📅 2022-12-27 - Unit testing framework.
* [Lookout](https://github.com/glebtsereteli/Lookout) ⭐ 21 | 🐛 8 | 🌐 Game Maker Language | 📅 2026-09-11 - Helpful debug overlay views.
...
* [Duck](https://github.com/imlazyeye/duck) ⭐ 13 | 🐛 0 | 🌐 Rust | 📅 2025-06-05 - A fast GML analyzer to enforce code styling and detect errors.
* [Ganary](https://github.com/bscotch/ganary) ⭐ 10 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-15 - Uses Olympus to perform regression tests.
...
* [Scribble](https://github.com/JujuAdams/scribble) ⭐ 417 | 🐛 31 | 🌐 Game Maker Language | 📅 2026-09-06 - Efficient multi-effects text renderer.
...
* [YUI](https://github.com/shdwcat/YUI) ⭐ 64 | 🐛 40 | 🌐 Game Maker Language | 📅 2026-09-19 - A UI system with live reloading, template system, data binding, and a drag and drop feature.
* [Bento](https://github.com/JujuAdams/Bento) ⭐ 55 | 🐛 1 | 🌐 Game Maker Language | 📅 2026-09-19 - Cross-platform UI framework.
...
* [GMUI](https://github.com/erkan612/GMUI) ⭐ 30 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-09-08 - Immediate mode GameMaker UI library, tons of UI components.
...
* [Krug's Localize System](https://github.com/Kruger0/Localize) ⭐ 21 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-08-12 - A localization system with real-time Google Sheets API synchronization.
...
* [SpriteSource](https://github.com/bscotch/stitch/tree/develop/packages/sprite-source) ⭐ 159 | 🐛 35 | 🌐 TypeScript | 📅 2026-06-15 - Utilities for creating art asset pipelines.
...
* [GMEXT-FMOD](https://github.com/YoYoGames/GMEXT-FMOD) ⭐ 74 | 🐛 2 | 🌐 HTML | 📅 2026-09-18 - Official support for FMOD in GameMaker.
...
* [GMRoomLoader](https://github.com/glebtsereteli/GMRoomLoader) ⭐ 133 | 🐛 6 | 🌐 Game Maker Language | 📅 2026-08-17 - Streamlined room loading at runtime. Great for reusable room prefabs and procedural generation.
...
* [BBMOD](https://github.com/blueburn-cz/BBMOD) ⭐ 119 | 🐛 5 | 🌐 Game Maker Language | 📅 2026-09-17 - 3D Rendering Solution. Comes with several modules to import obj, 3D camera setup, integration with ColMesh, and more.
...
* [Bonk](https://github.com/JujuAdams/Bonk) ⭐ 15 | 🐛 12 | 🌐 Game Maker Language | 📅 2026-09-19 - Another cool collision library handling a majority of collision shape use-cases.
...
* [HTTP GML](https://github.com/Sidorakh/http.gml) ⭐ 20 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-08-29 - Receive GET requests and upload files in GML.
...
* [Steamworks.gml](https://github.com/YAL-GameMaker/steamworks.gml) ⭐ 89 | 🐛 1 | 🌐 C++ | 📅 2026-09-02 - Various expansions to Steamworks SDK support in GameMaker: Studio.
...
* [GMNav](https://github.com/erkan612/GMNav) ⭐ 2 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-09-19 - High-performance, resumable navigation engine for GameMaker that handles grid, isometric, hex, and platformer maps with flow fields, dynamic costs, and multi-agent pathfinding.
...
* [OrbinautFramework](https://github.com/TrianglyRU/OrbinautFramework) ⭐ 128 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-09-18 - Accurate framework to make classic Sonic games.
...
* [Animated Flag](https://github.com/Grisgram/gml-animated-flag) ⭐ 12 | 🐛 0 | 🌐 Game Maker Language | 📅 2024-05-30 - Vertex-animated flag.
...
* If you need more general game development resources, check out [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 3,136 | 🐛 18 | 📅 2026-08-25 or [MagicTools](https://github.com/ellisonleao/magictools) ⭐ 17,334 | 🐛 15 | 🌐 Markdown | 📅 2026-09-14.
...
Have something awesome to share? Check out the [Contributing Guidelines](https://github.com/bytecauldron/awesome-gamemaker/blob/main/CONTRIBUTING.md) ⭐ 506 | 🐛 3 | 📅 2026-08-23.
