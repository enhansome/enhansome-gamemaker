...
* [Aseprite's source code](https://github.com/aseprite/aseprite) ⭐ 38,956 | 🐛 1,988 | 🌐 C++ | 📅 2026-08-24 - Can be compiled for free.
...
* [YUI](https://github.com/shdwcat/YUI) ⭐ 66 | 🐛 40 | 🌐 Game Maker Language | 📅 2026-08-24 - A UI system with live reloading, template system, data binding, and a drag and drop feature.
...
* [GMNav](https://github.com/erkan612/GMNav) ⭐ 2 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-08-23 - High-performance, resumable navigation engine for GameMaker that handles grid, isometric, hex, and platformer maps with flow fields, dynamic costs, and multi-agent pathfinding.
...
* If you need more general game development resources, check out [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 3,110 | 🐛 16 | 📅 2026-07-07 or [MagicTools](https://github.com/ellisonleao/magictools) ⭐ 17,193 | 🐛 14 | 🌐 Markdown | 📅 2026-08-17.
