...
* [Aseprite's source code](https://github.com/aseprite/aseprite) ⭐ 38,868 | 🐛 1,991 | 🌐 C++ | 📅 2026-08-20 - Can be compiled for free.
...
* [GML-OOP](https://github.com/Mtax-Development/GML-OOP) ⭐ 34 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-08-18 - A constructor library for operating the primary functionalities of GameMaker.
...
* [GM-ExtensionGenerator](https://github.com/YoYoGames/GM-ExtensionGenerator) ⭐ 25 | 🐛 2 | 🌐 C# | 📅 2026-08-18 - Official, schema-driven code generator for native extensions.
...
* [Catspeak](https://github.com/katsaii/catspeak-lang) ⭐ 133 | 🐛 9 | 🌐 Python | 📅 2026-08-19 - Cross-platform programming language for modding support.
...
* [GMLiteSearch](https://github.com/erkan612/GMLiteSearch) ⭐ 14 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-08-17 - Fast, flexible full‑text search for GameMaker. Built for small to medium datasets (10k‑50k+ docs) with real‑time indexing, fuzzy search, n‑grams, BM25/TF‑IDF scoring, and persistence.
...
* [Ganary](https://github.com/bscotch/ganary) ⭐ 10 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-19 - Uses Olympus to perform regression tests.
...
* [YUI](https://github.com/shdwcat/YUI) ⭐ 66 | 🐛 40 | 🌐 Game Maker Language | 📅 2026-08-17 - A UI system with live reloading, template system, data binding, and a drag and drop feature.
* [Textboxy](https://github.com/glitchroy/textboxy) ⭐ 65 | 🐛 9 | 🌐 Game Maker Language | 📅 2023-03-05 - Simple textboxes.
* [Bento](https://github.com/JujuAdams/Bento) ⭐ 53 | 🐛 2 | 🌐 Game Maker Language | 📅 2026-08-17 - Cross-platform UI framework.
...
* [GM Animate](https://github.com/KormexGit/GM-Animate) ⭐ 9 | 🐛 3 | 🌐 Game Maker Language | 📅 2026-08-18 - Sprite animation manager.
...
* [DmrVBM](https://github.com/Dreamer13sq/DmrVBM-blender-to-gms2) ⭐ 43 | 🐛 2 | 🌐 Python | 📅 2026-08-20 - Import/Export tools to load vertex buffer data out of Blender and into GMS.
* [Bonk](https://github.com/JujuAdams/Bonk) ⭐ 15 | 🐛 12 | 🌐 Game Maker Language | 📅 2026-08-18 - Another cool collision library handling a majority of collision shape use-cases.
...
* [OrbinautFramework](https://github.com/TrianglyRU/OrbinautFramework) ⭐ 125 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-08-20 - Accurate framework to make classic Sonic games.
...
* If you need more general game development resources, check out [Awesome Gamedev](https://github.com/Calinou/awesome-gamedev) ⭐ 3,108 | 🐛 15 | 📅 2026-07-07 or [MagicTools](https://github.com/ellisonleao/magictools) ⭐ 17,168 | 🐛 13 | 🌐 Markdown | 📅 2026-08-17.
...
Have something awesome to share? Check out the [Contributing Guidelines](https://github.com/bytecauldron/awesome-gamemaker/blob/main/CONTRIBUTING.md) ⭐ 497 | 🐛 2 | 📅 2026-08-16.
